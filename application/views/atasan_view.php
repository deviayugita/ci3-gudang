			...
			<div class="row row-mt-15em">
				<div class="col-md-7 mt-text text-left animate-box" data-animate-effect="fadeInUp">
					<h1>Detail <strong><?php echo $Atasan_list['Nama']  ?></strong></h1>
					 <a href="<?php echo site_url('Welcome/update/')?>"><button class="btn btn-primary"> UPDATE </button></a>	
				</div>
			</div>
		</div>
	</header>
...
<section id="about">
	<div class="gtco-cover gtco-cover-sm" style="background-image: url(http://localhost:8080/ci3-gudang/assets/images/img_bg_2.jpg)" data-stellar-background-ratio="0.5">
		...
		<div class="gtco-container text-center">
            ...
            <p><?php echo "<img src='".base_url()."assets/images/".$Atasan_list['Gambar']."' width='200' height='150'>"?></p>
          </div>
<font color="white">
          <div class="col-lg-12">
          	...
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Nama'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div> 
          <div class="col-lg-12">
          	<div class="col-lg-3"></div>
          	<div class="col-lg-3"><label>Jenis</label></div>
          	<div class="col-lg-1"><label>:</label></div>
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Jenis'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div> 
          <div class="col-lg-12">
          	<div class="col-lg-3"></div>
          	...
          	<div class="col-lg-1"><label>:</label></div>
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Merk'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div> 
          <div class="col-lg-12">
          	<div class="col-lg-3"></div>
          	...
          	<div class="col-lg-1"><label>:</label></div>
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Ukuran'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div> 
          <div class="col-lg-12">
          	<div class="col-lg-3"></div>
          	...
          	<div class="col-lg-1"><label>:</label></div>
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Tgl_masuk'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div> 
          <div class="col-lg-12">
          	<div class="col-lg-3"></div>
          	...
          	<div class="col-lg-1"><label>:</label></div>
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Harga'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div> 
          <div class="col-lg-12">
          	<div class="col-lg-3"></div>
          	...
          	<div class="col-lg-1"><label>:</label></div>
          	<div class="col-lg-2"><i><?php echo $Atasan_list['Jumlah'] ?></i></div>
          	<div class="col-lg-3"></div>
          </div>          
</font>
					</div>
