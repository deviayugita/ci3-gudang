...
<html>
  ...
  <div class="container">
    <h1>DATA TABLE</h1>
       ...
       <br />
       <button class="nav-link js-scroll-trigger" href="<?php echo site_url('Welcome/create_atasan/')?>">Atasan</button>
    ...
    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
				<?php foreach($data as $atasan){?>
				     <tr>
				         <td><?php echo $book->id_atasan;?></td>
				         <td><?php echo $book->Nama;?></td>
								<td><?php echo $book->Jenis;?></td>
								<td><?php echo $book->Merk;?></td>
								<td><?php echo $book->Ukuran;?></td>
								<td><?php echo $book->Tgl_masuk;?></td>
								<td><?php echo $book->Harga;?></td>
								<td><?php echo $book->Jumlah;?></td>
								<td><?php echo $book->Gambar;?></td>
